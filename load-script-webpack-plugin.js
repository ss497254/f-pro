...
class LoadScriptWebpackPlugin {
  apply(compiler) {
    compiler.hooks.compilation.tap("LoadScriptWebpackPlugin", (compilation) => {
      const { RuntimeGlobals } = compiler.webpack;
      compilation.hooks.runtimeRequirementInTree
        .for(RuntimeGlobals.loadScript)
        .tap("LoadScriptWebpackPlugin", (chunk, set) => {
...
module.exports = LoadScriptWebpackPlugin;
